...
pub const NUM_ADDITIONAL_THREADS: usize = 11;
pub const RENDER_DISTANCE: usize = 0;
pub const FOV_DISTANCE: usize = 0;
pub const CHUNK_DIMENSION: i32 = 2;
pub const CHUNK_PLANE_SIZE: i32 = 4;
pub const CHUNK_SIZE: usize = 8;
pub const BITS_PER_POSITION: u32 = 2;
...
pub const NUM_VERTICES_IN_BUCKET: u32 = 8;
