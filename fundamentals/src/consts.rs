...
pub const NUM_ADDITIONAL_THREADS: usize = 14;
...
pub const CHUNK_DIMENSION_WRAPPED: usize = 66;
pub const CHUNK_PLANE_SIZE_WRAPPED: usize = 4356;
pub const CHUNK_SIZE_WRAPPED: usize = 287496;
...
pub const NUM_VERTICES_IN_BUCKET: u32 = 524288;
