...
::phf::Map {
    ...
    entries: &[
        (BlockType::GRASS, [TextureCoordinates { tx: 0.0, ty: 0.5 },TextureCoordinates { tx: 0.0, ty: 0.5 },TextureCoordinates { tx: 0.0, ty: 0.5 },TextureCoordinates { tx: 0.0, ty: 0.5 },TextureCoordinates { tx: 0.5, ty: 0.5 },TextureCoordinates { tx: 0.5, ty: 0.0 }]),
