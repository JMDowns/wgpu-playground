...
let NUM_GRID_ALIGNED_SUBVOXEL_OBJECTS = 10000;
@group(1) @binding(2)
...
fn vs_main(
    ...
    // var gas_id = 0u;
    // END INLINE gas_id
    // INLINE vertex_corner
    // var vertex_corner = 0u;
    // END INLINE gas_id
...
// INLINE Calculate_Ambient_Occlusion
...
//     return vec4<f32>(0.0);
// }
// END INLINE Calculate_Ambient_Occlusion
