...
impl RenderState {
    pub fn new(
        ...
        chunk_index_bind_group_layout: &BindGroupLayout, 
        //visibility_bind_group_layout: &BindGroupLayout, 
        subvoxel_bind_group_layout: &BindGroupLayout, 
        grid_aligned_subvoxel_bind_group_layout: &BindGroupLayout
    ) -> Self {
